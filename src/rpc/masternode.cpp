...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print AurumCoinHunter address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "aurumcoinhunter",               "masternode",             &masternode,             true,  {} },
    { "aurumcoinhunter",               "masternodelist",         &masternodelist,         true,  {} },
    { "aurumcoinhunter",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "aurumcoinhunter",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "aurumcoinhunter",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "aurumcoinhunter",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
