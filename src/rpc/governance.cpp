...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in aurumcoinhunter.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("aurumcoinhunter.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "aurumcoinhunter",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "aurumcoinhunter",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "aurumcoinhunter",               "gobject",                &gobject,                true,  {} },
    { "aurumcoinhunter",               "voteraw",                &voteraw,                true,  {} },
