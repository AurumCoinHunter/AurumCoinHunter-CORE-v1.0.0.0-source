...
2. run aurumcoinhunterd with -printalert or -sendalert like this:
   /path/to/aurumcoinhunterd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.aurumcoinhunter.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/AurumCoinHunter Core:0.12.0.58/"));
