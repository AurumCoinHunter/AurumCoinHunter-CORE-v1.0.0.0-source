    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AU79-light"), QVariant("light"));
    ui->theme->addItem(QString("AU79-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("AU79-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("AU79-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("AU79-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AU79-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AU79-traditional"), QVariant("trad"));
