    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  aurumcoinhunter-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the AurumCoinHunter in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AU79, 0.1 AU79, 1 AU79 and 10 AU79 -- sort of like the paper money you use every day.</li> \
