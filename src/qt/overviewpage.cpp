...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(), unit(BitcoinUnits::AU79),
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("AU79")
        updateDisplayUnit();
...
{
    QString link="https://www.coinpayments.net/index.php?cmd=_pay&reset=1&merchant=6e59d27a05f52b2df84191cdf42017b4&item_name=MASTERNODE++3000+Coins+AU79+AurumCoin+Hunter+10+COINS+FREE-You+will+receive+the+coins+automatically+within+1-2+hours+of+purchase.&currency=BTC&amountf=0.25000000&quantity=1&allow_quantity=0&want_shipping=0&allow_extra=1&";
       QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_pushButton_2_clicked()
{
    QString link="https://aurumcoinhunter.org";
       QDesktopServices::openUrl(QUrl(link));
}
