...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all AurumCoinHunter related functionality
...
/*
    ...
    allow endless transaction that would bloat AurumCoinHunter and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("aurumcoinhunter-ps-server");
