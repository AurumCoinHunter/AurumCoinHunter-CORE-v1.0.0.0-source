...
This document provides guidelines for internationalization of the AurumCoinHunter Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aurumcoinhunter_en.ts` remains unchanged.
