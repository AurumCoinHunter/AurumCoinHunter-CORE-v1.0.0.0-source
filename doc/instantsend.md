...
This mechanism has been integrated into Bitcore-Node-AurumCoinHunter which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/aurumcoinhunterpay/insight-api-aurumcoinhunter#web-socket-api](https://github.com/aurumcoinhunterpay/insight-api-aurumcoinhunter#web-socket-api)
* API: [https://github.com/aurumcoinhunterpay/insight-api-aurumcoinhunter#instantsend-transactions](https://github.com/aurumcoinhunterpay/insight-api-aurumcoinhunter#instantsend-transactions)
...
By default, the AurumCoinHunter Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AurumCoinHunter Core daemon:
