...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid aurumcoinhunter address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid aurumcoinhunter address" in e.error['message'])
